...
def cr2_score_pval(ytrue, y2true, y1, y2, greater=True):
    """ytrue: The true series
    y2true: The true series for the second model
...
def cr2_score(ytrue, y2true, y1, y2):
    ...
    y2true: true time series for the second model
